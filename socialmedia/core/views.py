...
def search(request):
    ...
    username_profile_list = []  # Initialize the list here
...
def like_post(request):
    ...
    if like_filter is None:
        # The user has not liked this post before, so add a like
        ...
        like_filter.delete()
        post.no_of_likes = max(0, post.no_of_likes - 1)  # Ensure the likes count is non-negative
        post.save()
